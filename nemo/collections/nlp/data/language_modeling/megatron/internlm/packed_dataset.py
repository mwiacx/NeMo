...
from nemo.collections.nlp.data.language_modeling.megatron.internlm.single_dataset import JsonlDataset
from nemo.collections.nlp.data.language_modeling.megatron.internlm.utils import get_dataset_type_id
...
class PackedDatasetWithCut(PackedDataset):
    ...
    def __init__(
        ...
        super().__init__(dataset, max_length_per_sample, packed_length, use_packed_dataset)
    ...
    def cal_pos_unpack(self, index):
        if index == 0:
            ...
            pre_pos = index * self.micro_bsz

        pos = (index + 1) * self.micro_bsz
        return pre_pos, pos
